...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/p1/b702ts2x2755xvld8xz7n1j80000gn/0//com.apple.notificationcenter/db2/db" 'select * from app'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/onodaosamu/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/onodaosamu/.mailcheckrc"
# }
